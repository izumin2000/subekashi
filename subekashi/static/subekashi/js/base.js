...
const TUTORIALS = {
    ...
    "imitate": "模倣元・オマージュ元・歌詞の引用元・アレンジ元の曲を入力してください。<br>全てあなたの所為です。の曲を選択する場合は上部のボタンから、それ以外の曲を選択する場合から、下部の入力欄から検索することで選択できます。<br>入力欄に模倣曲のタイトルを入力してもヒットしない場合はまず、その模倣曲を情報を登録してください。<br>模倣曲は複数曲選択できます。",
